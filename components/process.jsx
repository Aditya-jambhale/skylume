            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-xl mb-5"
                  ...
                  <motion.div
                    className="absolute top-3 right-3 w-10 h-10 rounded-lg
                       bg-yellow-500/20 border border-yellow/40
                       backdrop-blur-sm flex items-center justify-center text-yellow-500"
                ...
                <div className="xl:pt-8 transition-all duration-300 group-hover:translate-y-1">
                  ...
                  <h3 className="font-bebas text-[1rem] tracking-[0.05em] text-white mb-2 uppercase leading-tight transition-colors duration-300 group-hover:text-yellow-500">
                    {step.title}
                  </h3>

                  <p className="font-barlow font-light text-[0.72rem] text-textMuted leading-[1.75] transition-colors duration-300 group-hover:text-white/70">
                    {step.desc}
                  </p>
                </div>
